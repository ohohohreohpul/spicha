...
const BASE =
  'group inline-flex items-center justify-center gap-2.5 rounded-full text-sm font-semibold tracking-[0.01em] transition-[transform,background-color,color,border-color] duration-[var(--dur-1)] ease-[var(--ease-out-quad)] active:translate-y-px disabled:cursor-not-allowed disabled:opacity-55';

const VARIANT = {
  primary:
    'bg-teal text-paper px-7 py-3.5 hover:bg-teal-deep shadow-[0_10px_30px_-16px_rgba(0,111,115,0.9)]',
  secondary:
