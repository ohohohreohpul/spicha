...
export const UI = {
  de: {
    ...
    hero: {
      promiseLabel: 'Persönlich begleitet',
      promiseTitle: 'Sie müssen noch nicht alles können.',
      promiseText: 'Sie bringen die Neugier mit. Wir zeigen die Handgriffe, üben mit Ihnen und korrigieren direkt — auf Deutsch und Thailändisch.',
      kicker: 'Standort Ahrensburg · seit 1997',
      headlineA: 'Ihre Hände',
      headlineB: 'können eine',
      headlineAccent: 'Zukunft',
      headlineC: 'bauen.',
      lead: 'Lernen Sie, Menschen mit Ihren Händen etwas Gutes zu tun. In Ahrensburg bei Hamburg begleiten wir Sie vom ersten Handgriff bis zur selbstständigen Anwendung.',
    ...
    sections: {
      orientation: {
        ...
        titleB: ' sollen?',
        lead: 'Ein neuer Anfang oder der nächste Schritt im Beruf? Drei kurze Antworten helfen uns, Ihren Einstieg einzugrenzen.',
      },
      finder: {
        index: '05',
      ...
      catalog: {
        index: '04',
        kicker: 'Das Programm',
        titleA: 'Raum für Ihren',
        titleAccent: 'nächsten Schritt',
        titleB: '',
        lead: 'Wählen Sie Ihren Bereich und entdecken Sie, was Sie lernen können. Voraussetzungen, Gebühren und nächste Termine stehen direkt beim Kurs.',
      },
      featured: {
        index: '07',
      ...
      learn: {
        index: '08',
        kicker: 'Der Kurstag',
        titleA: 'Aus Zuschauen wird',
        titleAccent: 'Können',
        titleB: '',
        lead: 'Sie schauen zu, probieren aus und bekommen direkt Rückmeldung. Entdecken Sie Schritt für Schritt, wie wir gemeinsam üben.',
      },
      outcomes: {
        index: '09',
  ...
  th: {
    ...
    hero: {
      promiseLabel: 'ครูดูแลทุกขั้นตอน',
      promiseTitle: 'ไม่ต้องเก่งมาก่อน ก็เริ่มได้',
      promiseText: 'แค่พร้อมเรียนรู้ ครูจะสาธิตให้ดู พาฝึก และช่วยแก้ท่าให้ตรงจุด สอบถามได้ทั้งภาษาไทยและเยอรมัน',
      kicker: 'สาขา Ahrensburg · ตั้งแต่ปี 1997',
      headlineA: 'สองมือคู่นี้',
      headlineB: 'สร้าง',
      headlineAccent: 'อนาคต',
      headlineC: 'ให้คุณได้',
      lead: 'เรียนรู้การดูแลผู้อื่นด้วยสองมือของคุณ ที่ Ahrensburg ใกล้ Hamburg ครูจะพาฝึกตั้งแต่ท่าแรกจนคุณลงมือทำได้ด้วยตัวเอง',
    ...
    sections: {
      orientation: {
        ...
        titleAccent: 'อะไรดี',
        titleB: '?',
        lead: 'อยากเริ่มอาชีพใหม่ หรือต่อยอดสิ่งที่ทำอยู่? ตอบคำถามสั้น ๆ สามข้อ เพื่อค้นหาจุดเริ่มต้นที่เหมาะกับคุณ',
      },
      finder: {
        index: '05',
      ...
      catalog: {
        ...
        titleA: 'เลือกเรียนเพื่อ',
        titleAccent: 'ก้าวต่อไป',
        titleB: '',
        lead: 'เลือกหมวดที่สนใจ แล้วดูว่าแต่ละหลักสูตรสอนอะไร พร้อมพื้นฐานที่ต้องมี ค่าเรียน และรอบเรียนถัดไป',
      },
      featured: {
        index: '07',
      ...
      learn: {
        ...
        titleA: 'จากดูครูทำ สู่การ',
        titleAccent: 'ทำได้เอง',
        titleB: '',
        lead: 'ดูครูสาธิต ลองทำ แล้วรับคำแนะนำทันที เลือกดูแต่ละขั้นตอนว่าเราฝึกไปด้วยกันอย่างไร',
      },
      outcomes: {
        index: '09',
